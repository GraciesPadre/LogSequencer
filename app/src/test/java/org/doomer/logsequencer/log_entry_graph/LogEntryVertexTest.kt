...
class LogEntryVertexTest {
    ...
    fun testAddingVertexToVertex() {
        ...
        assertEquals("2", edge?.logEntryVertex?.visitedUrl)
    ...
    fun testRemovingEdgeWhenThatEdgeDoesNotExist() {
        ...
        assertEquals("2", edgeAfterRemovingEdge?.logEntryVertex?.visitedUrl)
    ...
    fun testRemovingEdge() {
        ...
        assertEquals("3", edge?.logEntryVertex?.visitedUrl)
